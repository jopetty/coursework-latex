...
\RequirePackage{changepage} % adjustwidth environment
\RequirePackage[breakable,
                skins]{tcolorbox} % shaded theorems
...
% Define Colors
% Link colors
\definecolor{linkblue}{HTML}{0067BC}
\definecolor{linkgold}{HTML}{C1900B}
\definecolor{cover}{HTML}{2E303C}
...
\RenewDocumentCommand\footnote{ om } {
	\IfValueTF{#1}{
		...
		\textsuperscript{\hyperlink{fn:\thecfootnote}{[\thecfootnote]}}
		\note{\llap{\emph{\textsuperscript{\hypertarget{fn:\thecfootnote}{\thecfootnote}}}}#2}[#1]
	}{
		\refstepcounter{cfootnote}
		\textsuperscript{\hyperlink{fn:\thecfootnote}{[\thecfootnote]}}
		\note{\llap{\emph{\textsuperscript{\hypertarget{fn:\thecfootnote}{\thecfootnote}}}}#2}
	}
...
\DeclareDocumentCommand\C{} {\mathbb{C}} % xetex already has a \C command
\NewDocumentCommand\Z{} {\mathbb{Z}}
\NewDocumentCommand\Q{} {\mathbb{Q}}
\NewDocumentCommand\N{} {\mathbb{N}}
\NewDocumentCommand\F{} {\mathbb{F}}

% ISO Specified Characters
\NewDocumentCommand\im{} {\mathrm{i}} % Imaginary numbers
\NewDocumentCommand\e{} {\mathrm{e}} % Euler's constant
...
%% spacing and indentation right.
	...
	\newtcolorbox{blockbox}{
		...
		colframe = backgroundgrey, % Rule appears on page breaks
		parskip,
		boxrule = 0pt,
		sharp~corners,
		boxsep = 0.4cm,
...
%% spacing and indentation right.
	...
	% Create surrounding box
	\newtcolorbox{breakbox}{
		colback = backgroundgold,
		colframe = backgroundgold,
		parskip,
		sharp~corners,
		boxsep = 0.4cm,
		breakable,
