%% MARK: Class Options
% Flags for packages
\bool_new:N	\g_coursework_loadchem_bool	% Chemical Diagrams
...
\bool_gset_false:N	\g_coursework_loadchem_bool
...
\DeclareOption{chemistry}{\bool_gset_true:N \g_coursework_loadchem_bool}
...
% Table of Contents
\bool_new:N \g_coursework_toc_bool
\bool_gset_true:N \g_coursework_toc_bool
\DeclareOption{no-toc}{\bool_gset_false:N \g_coursework_toc_bool}
...
\LoadClass[letterpaper]{\c__coursework_class_parent_class_tl}
